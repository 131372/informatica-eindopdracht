...
function createLepton(name, anti, neutrino) {
    switch (name) {
        case 'e':
                var card = {name: "e", particle: "lepton", neutrino: neutrino, generation: 1, anti: anti, mass: 0.5, charge: 1, order: 0};
            break;
        case 'm':
                var card = {name: "m", particle: "lepton", neutrino: neutrino, generation: 2, anti: anti, mass: 106, charge: 1, order: 0};
            break;
        case 't':
                var card = {name: "t", particle: "lepton", neutrino: neutrino, generation: 3, anti: anti, mass: 1750, charge: 1, order: 0};
            break;
        default:
    }
    if (anti) {
